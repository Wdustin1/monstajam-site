...
export default function AlbumReleaseBanner() {
  return (
    <section className="mx-auto w-full max-w-7xl px-4 md:px-6 pt-5 relative z-10">
      <div className="relative overflow-hidden rounded-xl border border-white/10 bg-[#080A12] shadow-[0_18px_60px_rgba(0,0,0,0.45)]">
        ...
        <div className="relative grid gap-5 md:grid-cols-[116px_1fr_auto] items-center px-4 py-4 md:px-6">
          <div className="relative mx-auto md:mx-0 h-28 w-28 overflow-hidden rounded-lg border border-white/15 bg-black shadow-[0_0_28px_rgba(95,120,255,0.22)]">
            <Image
              src="/releases/cold-world-volume-1-release.jpg"
              alt="Cold World Volume 1 Monsta Hits release artwork"
              fill
          ...
          <div className="text-center md:text-left">
            ...
            <h2 className="text-balance text-2xl font-black leading-[0.95] tracking-tight text-white md:text-4xl">
              Tyler J - Cold World
            </h2>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-300 md:text-base">
              Volume 1 Monsta Hits lands June 1. Produced by Monsta Jam Productions and available on Spotify, Apple Music, and YouTube.
            </p>
          </div>

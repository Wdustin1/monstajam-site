export default function Footer() {
  return (
    <footer className="w-full border-t border-white/5 py-8 px-8 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
      <div className="flex items-center gap-4 mb-4 md:mb-0">
        <span>MonstaJam &copy; 2024</span>
        <div className="flex items-center gap-3">
          ...
          {/* X */}
          <a className="hover:text-white transition-colors text-lg font-bold" href="#">X</a>
          {/* Instagram */}
          <a className="hover:text-white transition-colors" href="#">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
